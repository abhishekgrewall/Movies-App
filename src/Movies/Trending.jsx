...
function Trending() {
  ...
  const fetchTrendingMovies = async () => {
    setIsLoading(true);
    try {
      let url = `https://api.themoviedb.org/3/trending/movie/week?api_key=1765089d00d8e9f1ddca4446029c93ee&page=${pageNumber}`;
      if (searchQuery) {
        url = `https://api.themoviedb.org/3/search/movie?api_key=1765089d00d8e9f1ddca4446029c93ee&query=${encodeURIComponent(searchQuery)}&page=${pageNumber}`;
      }
  ...
  return (
    <div>
      <h1 className="Tittle">Trending Movies</h1>

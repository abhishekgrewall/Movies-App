  ...
  useEffect(() => {
    const fetchMovies = async () => {
      ...
      if (searchQuery) {
        ...
        url = `https://api.themoviedb.org/3/movie/top_rated?api_key=1765089d00d8e9f1ddca4446029c93ee&page=${pageNumber}`;
      }
  ...
  return (
    <div>
      ...
      <div className="search-container">
        ...
        />
        <button onClick={handleSearch} style={{ color: "black", backgroundColor: "white", padding: "13px", fontSize: "13px",border:'2px solid black' }}>
          Search
        </button>
      </div>
